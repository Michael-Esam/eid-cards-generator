...
const PageFour = () => {
    ...
    const shareImage = async () => {
        ...
        if (canShareFile) {
            try { await navigator.share({ ...sharePayload, files: [file] }); return; }
                ...
                <div className="card split-card">
                    <div className="share-section">
                        ...
                        <div className="share-buttons-grid">
                            ...
                            <button className="share-btn snapchat" onClick={shareImage} disabled={!isReady}><FaSnapchatGhost size={28} /></button>
                            <button className="share-btn tiktok" onClick={shareImage} disabled={!isReady}><FaTiktok size={28} /></button>
